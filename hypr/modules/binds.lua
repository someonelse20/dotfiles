...
hl.bind(mainMod .. " + F", hl.dsp.exec_cmd("waterfox"))
hl.bind(mainMod .. " + G", hl.dsp.exec_cmd("steam"))
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd("dolphin"))
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd("rofi -show drun -theme murz"))
hl.bind(mainMod .. " + SPACE", hl.dsp.exec_cmd("rofi -show drun -theme murz"))
